...
test "V1Public Decrypt fail" {
    ...
    const res = e.decode(encoded3[0..225], public_key, f, i);
    try testing.expectError(error.PasetoIncorrectTokenFormat, res);

    const encoded1 = "";

    var encoded12: [325]u8 = undefined;
    const encoded13 = try std.fmt.hexToBytes(&encoded12, encoded1);

    const res2 = e.decode(encoded13[0..], public_key, f, i);
